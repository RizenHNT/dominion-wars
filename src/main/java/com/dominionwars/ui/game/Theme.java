...
public final class Theme {
    ...
    public static Color[] faction(String f) {
        if (f == null) f = "";
        switch (f) {
            case "烈焰帝国": return new Color[]{new Color(0x7a, 0x1f, 0x12), new Color(0xe2, 0x5a, 0x1f), new Color(0xff, 0xb3, 0x47)};
            case "深海联盟": return new Color[]{new Color(0x0c, 0x2b, 0x4e), new Color(0x1f, 0x6e, 0x9e), new Color(0x6f, 0xd6, 0xe8)};
            case "古木圣地": return new Color[]{new Color(0x1d, 0x40, 0x22), new Color(0x3f, 0x7d, 0x37), new Color(0xa7, 0xd9, 0x6b)};
            case "机械遗迹": return new Color[]{new Color(0x2e, 0x33, 0x3c), new Color(0x5f, 0x6e, 0x7e), new Color(0x9f, 0xc4, 0xd6)};
